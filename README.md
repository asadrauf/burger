...
> ![#1589F0](https://placehold.it/15/1589F0/000000?text=+) #A burger logger with MySQL, Node, Express, Handlebars and a homemade ORM (yum!). Using MVC design pattern.  Node and MySQL to query and route data in your app, and Handlebars to generate your HTML.
...
**This is a Eat-the-burger application**
